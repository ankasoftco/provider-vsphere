...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vsphere_v3.1.0_x5
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/vspheres/01-delete.yaml.tmpl.
