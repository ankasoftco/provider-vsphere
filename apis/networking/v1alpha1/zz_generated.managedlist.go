...
func (l *VSphereDistributedPortGroupList) GetItems() []resource.Managed {
...
func (l *VSphereDistributedVirtualSwitchList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
func (l *VSphereHostVirtualSwitchList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
